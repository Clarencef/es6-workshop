...
test.only('is an actual array, unlike arguments', () => {
  function resty(...args) {
    return args
  }
...
test.only('it can default all arguments, optionally', () => {
  // Modify the method signature of `myFunction` to allow for all args to be optional

  function myFunction({name='Albert', age=37, favoriteBand='Mayday'} = {}) {
